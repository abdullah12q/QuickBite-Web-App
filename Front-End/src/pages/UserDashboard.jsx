...
import { getAuthToken, getUserId } from "../util/auth"; // Util functions to get token and user ID
...
// Wrapper component for user dashboard page
  ...
  return (
    <div className="container mx-auto mt-14 p-8 bg-gray-900 text-white ">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-orange-500">User Dashboard</h1>
      </header>
